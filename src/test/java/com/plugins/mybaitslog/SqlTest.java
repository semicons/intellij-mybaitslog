...
//        String totalLine = "[DEBUG] [http-nio-8080-exec-1] 19:36:33 c.l.p.m.P.selectUserMenu 143: <==      Total: 58 ";
//        final String[] strings = SqlProUtil.restoreSql(preparingLine, parametersLine,totalLine);
//        System.out.println(strings[0]);
//        System.out.println(strings[1]);
